...
function Tasks() {
 ...
 async function handleComplete(id, completed) {
  ...
  const  filtered = tasks.filter( t =>{
    ...
    const matchCategory = taskCategory === "الكل" ? true : t.category === taskCategory
        ...
        {showForm && (
         ...
         {["الكل", "عالية", "متوسطة", "منخفضة", "منجزة"].map(f => (
          ...
          <div className="category-filters">
            {["الكل", "دراسه", "عمل", "شخصي", "اخرى"].map( c =>(
            <div key={c} className={filter === c ? "filter active" : "filter"}
             ...
             <div key={task.id} className={`task-card ${task.priority === "عاليه" ? "high" : task.priority === "متوسطه" ? "medium" : "low" } ${task.completed ? "done" : ""} `}>
              ...
              <div className="task-info">
                ...
                <div className="task-meta">
                  <span className="task-tag">{task.taskCategory}</span>
